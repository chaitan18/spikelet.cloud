        ...
        <ul class="nav navbar-nav">
		 <li class="dropdown tasks-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-danger"><div id="cartItemsNo">
			 <?php
				$cart_items = $this->session->userdata('cart_products');
		  ...
		  <?php 
		  if(empty($this->session->userdata('login_user_id')) || $this->session->userdata('login_user_id')==0 )){		
		  ?>
