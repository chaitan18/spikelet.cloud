...
<div class="content-wrapper">
   ...
   <section class="content-header">
      <h1>Parent registration page<small></small></h1>
      <ol class="breadcrumb">
         <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
         <li><a href="#">Parent registration page</a></li>
      </ol>
   </section>
      ...
      <div class="col-md-12">
         <div class="box box-warning">
            ...
            <div class="box-footer">
               <button class="btn btn-primary addparent" style="float: right;">Submit</button>
            </div>
         </div>
      </div>
      <div class="col-md-12">
...
<script type="text/javascript">
  $(function(){
    $('.addparent').on('click', function(){
      ...
      $('input[type=text]', '#add_parent').each(function() {
      ...
      $('input[type=radio]', '#add_parent').each(function() {
      ...
      if(error == 0){
        var spinkletForm = new FormData($('#add_parent')[0]);
        $.ajax({
          url : "<?php echo base_url(); ?>landingpage/insert_parent",
          type : "post",
          dataType : "json",
          data: spinkletForm,
          processData: false,
