...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="col-xs-12">
          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th>Address</th>
                <th>Spinklet Name</th>
                <!-- <th>Spinklet Alias Name</th> -->
                <th>Added Date</th>
                <th>Action</th>
              </tr>
            </thead>
            <tbody>
              <?php if(count($spinklet_list) > 0){
                foreach ($spinklet_list as $key => $value) { ?>
                  <tr>
                    ...
                    <td><?php echo $value['spikelet_name']; ?></td>
                    <!-- <td><?php echo $value['spikelet_alias']; ?></td> -->
      ...
      <a href="<?php echo base_url(); ?>superadmin/register_spinklet" class="btn btn-sm btn-primary" style="float: right;">Register Spinklet</a>
    </div>    
  </section>
</div>
