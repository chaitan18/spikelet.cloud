...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="col-xs-12">
      <div class="box">
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover">
            ...
            <tbody>
              <?php if(count($parent_child_info) > 0){
                foreach ($parent_child_info as $key => $value) { ?>
                  <tr>
      ...
      <a href="<?php echo base_url(); ?>parentcontroller/add_child" class="btn btn-sm btn-primary" style="float: right;">Register Student</a>
    </div>    
  </section>
</div>
