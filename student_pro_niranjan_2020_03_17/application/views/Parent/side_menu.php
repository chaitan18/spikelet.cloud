  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li> <a href="<?php echo base_url();?>parentcontroller/add_child"> <span>Add Child</span> </a></li>
        <li> <a href="<?php echo base_url();?>parentcontroller/child_list"> <span>Child List</span> </a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
