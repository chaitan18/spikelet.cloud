            ...
            <ul class="nav nav-stacked">
              ...
              <li>
                <div style="padding: 10px;">
                  <button class="btn-success btn-sm" style="vertical-align:middle; float: right; margin-bottom: 10px;" onclick="submitform(<?php echo $j;?>)">Add to Cart</button>
                </div>
              </li>
            </ul>
          </div>
     ...
     $.ajax({
      ...
      success : function(data) {
        ...
        data['cart_products'].forEach(function(option, index){
          CART_ITEMS_HTML += '<li><ul class="menu"><li><a href="#"><h3>'+option.spikelet_name+'-'+option.spikelet_cost+
                       '</h3></a></li></ul></li>' ;
        });
