...
const homeRoutes: Routes = [
    ...
    { path: "Tested", component: Tested},
    { path: "spquizes", component: SpquizesHomeComponent},
    { path: "spquiz-dashboard", component: SpquizesDashboardComponent},
    { path: "spquizt-dashboard", component: SpquizestDashboardComponent},
    { path: "spquizt-addquestion", component: spquiztAddquestionComponent},
    { path: "spquizt-viewquestion", component: spquiztViewquestionComponent},
    { path: "spquizt-bulkquestion", component: spquiztBulkquestionComponent},
    { path: "spquiz-quiz", component: SpquizesQuizpageComponent},
    { path: "spquiz-quiztest", component: SpquizesQuiztestComponent},
