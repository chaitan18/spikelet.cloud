...
@Component({
  selector: 'app-spikeletlogin',
  templateUrl: './spikeletlogin.component.html',
  styleUrls: ['./spikeletlogin.component.css']
})
export class SpikeletLoginComponent implements OnInit {
  email: string;
  password: string;
  errorMessage: string;
  mfaStep = false;
...
console.log("LoginComponent constructor");
  ...
  onLogin() {
    ...
    if (this.email == null || this.password == null) {
        ...
        if(this.email =="spikelet18@gmail.com" && this.password=="123456"){
            this.router.navigate(['/spikelethome']);
        }else{
